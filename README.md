...
<img width=800 alt="전체시스템 흐름도" src="images/전체시스템흐름도.png">
...
- **인증 방식 : 이미지 인증 흐름**
<img width=700 alt="사진인증흐름" src="images/사진 인증 flow.png">
...
> **API 명세서**: [swagger-ui](http://52.14.77.12:8080/swagger-ui/index.html)
